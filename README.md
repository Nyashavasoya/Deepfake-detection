...
- 4. Dual Graph Attention Paths
4.1 Spectral Graph Path (GAT-S)
...
- 5. Heterogeneous Graph Fusion (HS-GAL)
Input:
...
- 6. Hierarchical Pooling & Readout
...
Performance Results on the In-The-Wild Dataset
